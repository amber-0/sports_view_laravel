...
<body class="bg-yellow-50">
  ...
  <header class="text-gray-600 body-font z-10">
    <!-- 背景画像 -->
    <img class="z-0 bg-fixed absolute fixed" src="img/bg_image.png">
    <div class="container relative mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center z-20">
      <a class="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0">
        <!-- アイコン -->
        <img src="img/icon.png" class="w-10 h-10 text-white p-2 bg-yellow-500 rounded-full">
        <span class="ml-3 text-xl text-gray-200">SPORTS VIEW</span>
      </a>
      <div class="ml-2 md:ml-auto text-base justify-end">
